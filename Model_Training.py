...
from torchvision import models  # <--- Use torchvision EfficientNet
...
def build_model(num_classes, dropout=0.6):
    # Use torchvision EfficientNet B4
...
# ==========================
def main():
    ROOT_DIR = "/content/ROI_again"  # path to your images
    CSV_DIR = Path("/content/results/Dataset")  # path where CSVs are unzipped
    ...
    for epoch in range(1, EPOCHS + 1):
        ...
        if val_acc > best_val_acc:
          ...
          torch.save(checkpoint, OUT_DIR / "efficientnet_b4_best.pth")
          print(" Saved checkpoint with class info")
    ...
    # Download it directly to your PC
    from google.colab import files
    files.download(str(OUT_DIR / "efficientnet_b4_best.pth"))
