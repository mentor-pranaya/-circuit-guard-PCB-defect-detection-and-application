...
1️⃣ Clone Repository git clone --single-branch --branch chittem_surya https://github.com/mentor-pranaya/-circuit-guard-PCB-defect-detection-and-application.git
