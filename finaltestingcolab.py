...
# Upload your dataset ZIP (images + roi_data.csv)
uploaded = files.upload()        # choose r.zip (or any name)
...
ROOT_DIR   = Path("/content/dataset/r")        # folder containing images
TEST_CSV   = Path("/content/dataset/roi_data.csv")
OUT_DIR    = Path("/content/train")            # training folder (where model file is stored)
RESULTS_DIR = Path("/content/testing")         # where we’ll save outputs
RESULTS_DIR.mkdir(parents=True, exist_ok=True)

MODEL_PATH = OUT_DIR / "efficientnet_b4_final.pth"
