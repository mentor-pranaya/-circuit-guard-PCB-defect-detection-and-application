...
- Works for every difference image in Module 1 output
- Detects contours of defects
- Extracts cropped ROIs
- Saves visualization images with contours & bounding boxes
"""
