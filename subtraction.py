...
# Function to preprocess and subtract with Otsu + Border Mask

def preprocess_and_subtract(reference_path, defect_path, border_thickness=10):
    # Load reference + defect images in grayscale
    ...
    # Otsu’s threshold
    _, defect_mask = cv2.threshold(diff, 0, 255, cv2.THRESH_BINARY + cv2.THRESH_OTSU)
