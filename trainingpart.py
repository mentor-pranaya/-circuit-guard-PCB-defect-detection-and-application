...
# ==========================
ROOT_DIR = Path(r"C:\Users\phaneendra ybs\Downloads\r")           # folder with images
CSV_FILE = Path(r"C:\Users\phaneendra ybs\Downloads\r\roi_data.csv")
OUT_DIR  = Path(r"C:\Users\phaneendra ybs\Downloads\training")    # output folder
...
def main():
    ...
    # ===== Save Training Curves (no blocking) =====
